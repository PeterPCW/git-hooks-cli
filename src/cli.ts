 ...
 */
function getConfigFromPackageJson(): Record<string, string | string[]> | null {
 ...
 */
function getConfigFromGitHookrc(): Record<string, string | string[]> | null {
 ...
 */
function getConfiguredHooks(): Record<string, string | string[]> {
 ...
 * Run a hook manually
 */
function runHook(hookName: string, args: string[]): void {
  const config = getConfiguredHooks()
